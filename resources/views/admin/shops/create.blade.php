    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.shops.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shop_name') ? 'is-invalid' : '' }}" type="text" name="shop_name" id="shop_name" value="{{ old('shop_name', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('verkaufbar') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="verkaufbar" id="verkaufbar" value="1" {{ old('verkaufbar', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('verkaufs_preis') ? 'is-invalid' : '' }}" type="text" name="verkaufs_preis" id="verkaufs_preis" value="{{ old('verkaufs_preis', '') }}">
