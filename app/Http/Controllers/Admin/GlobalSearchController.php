...
{
    private $models = [
        'TebexLizenzen' => 'cruds.tebexLizenzen.title',
        'Kategorien'    => 'cruds.kategorien.title',
        'Item'          => 'cruds.item.title',
        'Fahrzeuge'     => 'cruds.fahrzeuge.title',
        'Werkbanke'     => 'cruds.werkbanke.title',
        'Shop'          => 'cruds.shop.title',
        'Datenbank'     => 'cruds.datenbank.title',
    ];
