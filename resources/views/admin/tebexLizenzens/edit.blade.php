...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.tebexLizenzen.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.tebex-lizenzens.update", [$tebexLizenzen->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="haendler">{{ trans('cruds.tebexLizenzen.fields.haendler') }}</label>
                <input class="form-control {{ $errors->has('haendler') ? 'is-invalid' : '' }}" type="text" name="haendler" id="haendler" value="{{ old('haendler', $tebexLizenzen->haendler) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('gekauft_am') ? 'is-invalid' : '' }}" type="text" name="gekauft_am" id="gekauft_am" value="{{ old('gekauft_am', $tebexLizenzen->gekauft_am) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tebexid') ? 'is-invalid' : '' }}" type="text" name="tebexid" id="tebexid" value="{{ old('tebexid', $tebexLizenzen->tebexid) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('preis') ? 'is-invalid' : '' }}" type="text" name="preis" id="preis" value="{{ old('preis', $tebexLizenzen->preis) }}">
                @if($errors->has('preis'))
                    <div class="invalid-feedback">
                        {{ $errors->first('preis') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" type="text" name="url" id="url" value="{{ old('url', $tebexLizenzen->url) }}">
                @if($errors->has('url'))
                    <div class="invalid-feedback">
                        {{ $errors->first('url') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('produkt') ? 'is-invalid' : '' }}" name="produkt" id="produkt">{!! old('produkt', $tebexLizenzen->produkt) !!}</textarea>
