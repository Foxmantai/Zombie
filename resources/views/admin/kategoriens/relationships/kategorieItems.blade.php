...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-kategorieItems">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($items as $key => $item)
                        <tr data-entry-id="{{ $item->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $item->seltenes_item ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-kategorieItems:not(.ajaxTable)').DataTable({ buttons: dtButtons })
